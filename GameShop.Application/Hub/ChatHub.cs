...
namespace SignalRChat.Hubs
{
    public class ChatHub : Hub
    {
        ...
        private readonly IDictionary<string, AppUser> _connections;

        public ChatHub(IDictionary<string, AppUser> connections)
        {
            _botUser = "MyChat Bot";            
        ...
        {
            if (_connections.TryGetValue(Context.ConnectionId, out AppUser userConnection))
            {
        ...
        public async Task JoinRoom(AppUser userConnection)
        {
